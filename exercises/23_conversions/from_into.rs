...
// fournie n'est pas convertible en objet `Person`.
...
// TODO: Complète cette implémentation de `From` pour pouvoir analyser une `Person`
...
// 2. Si l'opération de division renvoie moins ou plus de 2 éléments, renvoie la
//    valeur par défaut de `Person`.
// 3. Utilise le premier élément de l'opération de division comme nom.
// 4. Si le nom est vide, renvoie la valeur par défaut de `Person`.
// 5. Analyse le deuxième élément de l'opération de division en `u8` comme âge.
// 6. Si l'analyse de l'âge échoue, renvoie la valeur par défaut de `Person`.
