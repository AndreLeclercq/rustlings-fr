// Nous collectons différents fruits pour faire un délicieux gâteau aux fruits. Pour cela,
// nous avons un panier, que nous représenterons sous forme de hash map (table de hachage). La clé
...
// Pomme (4), Mangue (2) et Litchi (5) sont déjà dans la hash map du panier. Tu
...
// d'insérer plus des fruits qui sont déjà dans le panier (Pomme,
// Mangue et Litchi).
...
fn fruit_basket(basket: &mut HashMap<Fruit, u32>) {
    ...
    for fruit in fruit_kinds {
        // Si le fruit n'existe pas, insère-le avec une certaine valeur.
