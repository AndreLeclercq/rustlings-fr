...
//
// Tu dois construire un tableau de scores contenant le nom de l'équipe, le nombre
// total de buts marqués par l'équipe, et le nombre total de buts encaissés par l'équipe.
...
fn build_scores_table(results: &str) -> HashMap<&str, TeamScores> {
    ...
    for line in results.lines() {
        ...
        // Insère les valeurs par défaut avec des zéros si une équipe n'existe pas encore.
        let team_1 = scores.entry(team_1_name).or_default();
        // Met à jour les valeurs.
        team_1.goals_scored += team_1_score;
        team_1.goals_conceded += team_2_score;

        // De même pour la deuxième équipe.
...
Angleterre,Espagne,1,0";
    ...
    fn build_scores() {
        ...
        assert!(
            ["Angleterre", "France", "Allemagne", "Italie", "Pologne", "Espagne"]
                .into_iter()
